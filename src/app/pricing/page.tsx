    ...
    <div className="space-y-16 py-12">
      ...
      <section className="max-container">
        <div className="text-center max-w-xl mx-auto mb-8 space-y-2">
          <h2 className="text-2xl font-bold text-[#0F172A]">Estimate Your Pickup Total</h2>
        ...
        <div className="bg-white rounded-3xl border border-slate-200 shadow-md overflow-hidden">
          <div className="p-6 sm:p-8 bg-slate-900 text-white flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 px-4 py-2 bg-amber-500 hover:bg-amber-400 text-slate-950 text-xs font-bold rounded-xl shrink-0"
            >
            ...
            {priceItems.map((row, idx) => (
              ...
              >
                <div className="space-y-1 max-w-md">
                  <h3 className="font-bold text-[#0F172A] text-base">{row.item}</h3>
                  <p className="text-xs text-slate-500">{row.desc}</p>
                </div>
                <div className="text-lg font-black text-[#2563EB] bg-blue-50 px-4 py-1.5 rounded-xl shrink-0">
                  {row.price}
                </div>
              </div>
            ))}
      ...
      <section className="max-container max-w-3xl">
        <div className="bg-gradient-to-r from-[#1E3A8A] to-[#2563EB] text-white rounded-3xl p-8 text-center space-y-6 shadow-xl">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link
              href="/contact"
              className="px-8 py-3.5 bg-amber-500 hover:bg-amber-400 text-slate-950 font-extrabold rounded-xl shadow text-sm transition-all"
            >
              Book Pickup Now
            </Link>
          </div>
