    ...
    <div className="space-y-16 py-12">
      ...
      <section className="bg-[#1E3A8A] text-white py-16">
        <div className="max-container text-center space-y-4 max-w-3xl">
          <span className="bg-amber-500 text-slate-950 text-xs font-extrabold px-3.5 py-1 rounded-full uppercase tracking-wider">
            Fast Response Team
          </span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-5 bg-white rounded-3xl p-8 border border-slate-200 shadow-md space-y-8">
            <div className="space-y-3">
              <h2 className="text-2xl font-extrabold text-[#0F172A]">Get In Touch</h2>
            ...
            <div className="space-y-4 text-sm text-slate-700">
              <div className="flex items-start gap-3.5 p-3.5 bg-slate-50 rounded-2xl">
                ...
                <div>
                  <strong className="block text-[#0F172A] font-bold">Store Location:</strong>
              ...
              <div className="flex items-start gap-3.5 p-3.5 bg-slate-50 rounded-2xl">
                ...
                <div>
                  <strong className="block text-[#0F172A] font-bold">Phone / Text Support:</strong>
                  <a href="tel:+13238287503" className="text-[#2563EB] font-extrabold hover:underline">
                    +1 (323) 828-7503
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3.5 p-3.5 bg-slate-50 rounded-2xl">
                ...
                <div>
                  <strong className="block text-[#0F172A] font-bold">Email Address:</strong>
              ...
              <div className="flex items-start gap-3.5 p-3.5 bg-slate-50 rounded-2xl">
                ...
                <div>
                  <strong className="block text-[#0F172A] font-bold">Business Hours:</strong>
          ...
          <div className="lg:col-span-7 bg-white rounded-3xl p-8 border border-slate-200 shadow-md">
            {submitted ? (
              <div className="py-12 text-center space-y-4">
                ...
                <h3 className="text-2xl font-black text-[#0F172A]">Pickup Request Received!</h3>
                ...
                <button
                  ...
                  className="px-6 py-2.5 bg-[#1E3A8A] text-white font-bold text-sm rounded-xl"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  <h2 className="text-2xl font-extrabold text-[#0F172A]">Schedule Doorstep Pickup</h2>
                ...
                <button
                  type="submit"
                  className="w-full py-4 bg-[#2563EB] hover:bg-blue-700 text-white font-extrabold rounded-xl shadow-lg hover:shadow-xl transition-all duration-150 flex items-center justify-center gap-2 text-base"
                >
