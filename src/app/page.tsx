...
export default function Home() {
  ...
  return (
    <div className="space-y-20 pb-16">
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-b from-blue-900/10 via-slate-50 to-white pt-10 pb-16 lg:pt-16 lg:pb-24">
        <div className="max-container grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          {/* Left Hero Box */}
          <div className="lg:col-span-7 space-y-6">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-100 text-[#1E3A8A] text-xs sm:text-sm font-bold tracking-wide">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-[#0F172A] tracking-tight leading-[1.1]">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#1E3A8A] via-[#2563EB] to-emerald-600">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-2">
              <Link
                href="/contact"
                className="inline-flex items-center justify-center gap-2 px-7 py-4 text-base font-extrabold text-white bg-[#2563EB] hover:bg-blue-700 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-150 active:scale-98"
              >
            ...
            <div className="pt-4 flex flex-wrap gap-y-2 gap-x-6 text-xs sm:text-sm font-semibold text-slate-600">
              <span className="flex items-center gap-1.5">
                <CheckCircle2 className="w-4 h-4 text-emerald-600" /> Free Pickup & Delivery
              </span>
              <span className="flex items-center gap-1.5">
                <CheckCircle2 className="w-4 h-4 text-emerald-600" /> 100% Non-Toxic & PERC-Free
              </span>
              <span className="flex items-center gap-1.5">
                <CheckCircle2 className="w-4 h-4 text-emerald-600" /> Same-Day Service Available
              </span>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative mx-auto max-w-md lg:max-w-none">
              ...
              <div className="bg-gradient-to-tr from-[#1E3A8A] to-[#2563EB] rounded-3xl p-6 text-white shadow-2xl space-y-6 relative overflow-hidden">
                <div className="flex items-center justify-between">
                  <span className="text-xs uppercase tracking-widest font-bold text-blue-200">
                    Beachwood Express Care
                  </span>
                  <span className="bg-emerald-500 text-white text-[11px] font-extrabold px-2.5 py-1 rounded-full">
                    Free Delivery
                  </span>
                </div>
                ...
                <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-4 flex items-center gap-3">
                  <div className="w-12 h-12 rounded-xl bg-amber-400 flex items-center justify-center text-slate-950 font-black text-xl shrink-0">
                    4.9★
                  </div>
                  <div>
                    ...
                    <p className="text-[11px] text-blue-200">250+ Verified Google Reviews</p>
                  </div>
                </div>

                <div className="pt-2 border-t border-white/15 flex items-center justify-between text-xs text-blue-100">
                  <span className="flex items-center gap-1">
                    <MapPin className="w-3.5 h-3.5 text-emerald-300" /> 2699 Beachwood Dr, LA
                  </span>
                  <a href="tel:+13238287503" className="font-bold text-amber-300 hover:underline">
                    +1 (323) 828-7503
                  </a>
                </div>
              </div>
      ...
      {/* Core Services Overview (Modularized Client Component) */}
      ...
      <section className="bg-blue-50/50 py-16 border-y border-blue-100">
        <div className="max-container space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-xs relative">
              <div className="w-10 h-10 rounded-xl bg-[#1E3A8A] text-white font-extrabold flex items-center justify-center text-lg mb-4">
                1
              </div>
              <h3 className="font-bold text-[#0F172A] text-lg mb-2">Schedule Online</h3>
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-xs relative">
              <div className="w-10 h-10 rounded-xl bg-[#2563EB] text-white font-extrabold flex items-center justify-center text-lg mb-4">
                2
              </div>
              <h3 className="font-bold text-[#0F172A] text-lg mb-2">We Collect</h3>
              <p className="text-slate-600 text-sm leading-relaxed">
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-xs relative">
              <div className="w-10 h-10 rounded-xl bg-emerald-600 text-white font-extrabold flex items-center justify-center text-lg mb-4">
                3
              </div>
              <h3 className="font-bold text-[#0F172A] text-lg mb-2">Eco Care & Press</h3>
              <p className="text-slate-600 text-sm leading-relaxed">
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-xs relative">
              <div className="w-10 h-10 rounded-xl bg-amber-500 text-slate-950 font-extrabold flex items-center justify-center text-lg mb-4">
                4
              </div>
              <h3 className="font-bold text-[#0F172A] text-lg mb-2">Fresh Delivery</h3>
              <p className="text-slate-600 text-sm leading-relaxed">
      ...
      <section className="max-container">
        <div className="bg-white rounded-3xl border border-slate-200 overflow-hidden shadow-lg grid grid-cols-1 lg:grid-cols-12">
          <div className="lg:col-span-5 p-8 lg:p-10 space-y-6 flex flex-col justify-between">
            <div className="space-y-4">
              <span className="bg-blue-100 text-[#1E3A8A] text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider">
                Store Location
              </span>
      ...
      <section className="max-container">
        <div className="bg-gradient-to-r from-[#1E3A8A] via-[#2563EB] to-blue-800 rounded-3xl p-8 sm:p-12 text-white text-center space-y-6 shadow-2xl relative overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 pt-2">
            <Link
              href="/contact"
              className="w-full sm:w-auto px-8 py-4 bg-amber-500 hover:bg-amber-400 text-slate-950 font-extrabold rounded-2xl shadow-lg hover:shadow-xl transition-all duration-150 text-base"
            >
              Schedule Pickup Now
            </Link>
            <a
