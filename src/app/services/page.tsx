...
import { CheckCircle2, ArrowRight, Shield, Sparkles, Clock, Truck } from "lucide-react";
    ...
    <div className="space-y-16 py-12">
      ...
      <section className="bg-[#1E3A8A] text-white py-16">
        <div className="max-container text-center space-y-4 max-w-3xl">
          <span className="bg-blue-800 text-blue-200 border border-blue-700 text-xs font-bold px-3.5 py-1 rounded-full uppercase tracking-wider">
            ...
            >
              <div className="space-y-4">
                <div className="flex flex-wrap justify-between items-start gap-2">
                  ...
                  <span className="text-lg font-black text-[#2563EB] bg-blue-50 px-3 py-1 rounded-xl">
                    {service.price}
                  </span>
                </div>
              ...
              <div className="pt-4 border-t border-slate-100">
                <Link
                  href="/contact"
                  className="w-full inline-flex items-center justify-center gap-2 py-3 bg-[#1E3A8A] hover:bg-[#2563EB] text-white font-bold rounded-xl text-sm transition-colors"
                >
      ...
      <section className="max-container">
        <div className="bg-emerald-50 border border-emerald-200 rounded-3xl p-8 text-center max-w-3xl mx-auto space-y-4">
